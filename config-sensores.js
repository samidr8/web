document.addEventListener('DOMContentLoaded', function () {
  ...
  `;
    ...
    // Variables globales para controlar el estado de la linterna
        ...
        if (flashOn) {
            ...
            if (flashTrack) {
                flashTrack.applyConstraints({
                    ...
                    // No detenemos el stream, solo apagamos la linterna
                    // Mantenemos la cámara activa pero sin linterna
                }).catch(err => {
